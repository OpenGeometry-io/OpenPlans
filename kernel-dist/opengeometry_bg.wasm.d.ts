...
export function __wbg_get_basemesh_extruded(a: number): number;
export function __wbg_set_basemesh_extruded(a: number, b: number): void;
export function __wbg_get_basemesh_is_polygon(a: number): number;
export function __wbg_set_basemesh_is_polygon(a: number, b: number): void;
...
export function basegeometry_reset_geometry(a: number): void;
export function __wbg_baseflatmesh_free(a: number, b: number): void;
export function __wbg_get_baseflatmesh_id(a: number): number;
export function __wbg_set_baseflatmesh_id(a: number, b: number): void;
...
export function baseflatmesh_new(a: number): number;
