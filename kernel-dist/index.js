...
class BaseFlatMesh {
  ...
  */
  get id() {
    const ret = wasm.__wbg_get_baseflatmesh_id(this.__wbg_ptr);
    return ret >>> 0;
  }
  /**
  * @param {number} arg0
  */
  set id(arg0) {
    wasm.__wbg_set_baseflatmesh_id(this.__wbg_ptr, arg0);
  }
  /**
  * @returns {boolean}
  */
  ...
  */
  constructor(id) {
    const ret = wasm.baseflatmesh_new(id);
...
class Vector3D {
  ...
  */
  clone() {
    const ret = wasm.vector3d_clone(this.__wbg_ptr);
    return Vector3D.__wrap(ret);
  }
}
...
class SpotLabel extends CSS2DObject {
    constructor() {
...
class BasePoly extends Mesh {
    ...
    addVertex(threeVertex) {
        ...
        if (this.isTriangulated) {
            ...
            (_a = this.polygon) === null || _a === void 0 ? void 0 : _a.reset_polygon();
            this.isTriangulated = false;
        ...
        const backupVertex = new Vector3D(parseFloat(threeVertex.x.toFixed(2)), 0, parseFloat(threeVertex.z.toFixed(2)));
        this.layerBackVertices.push(backupVertex);
        const vertex = new Vector3D(parseFloat(threeVertex.x.toFixed(2)), 
    ...
    addFlushBufferToScene(flush) {
        ...
        const material = new MeshStandardMaterial({ color: 0xff0000, transparent: true, opacity: 0.5, side: DoubleSide });
        this.geometry = geometry;
        this.material = material;
...
export { BasePoly, FlatMesh, OpenGeometry, SpotLabel, Vector3D };
